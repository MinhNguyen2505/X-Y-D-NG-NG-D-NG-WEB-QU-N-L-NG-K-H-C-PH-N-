-- =============================================================
-- FULL RESET + INSERT DAY DU
-- Chay 1 lan duy nhat trong phpMyAdmin -> Import
-- Xoa sach toan bo data cu va insert lai tu dau
-- Password: 123456
-- =============================================================
...
DELETE FROM dang_ky_thi_lai;
DELETE FROM dang_ky_dinh_huong;
DELETE FROM dinh_huong;
DELETE FROM dang_ky_nguyen_vong;
DELETE FROM nguyen_vong_mon_hoc;
DELETE FROM ke_hoach_nguyen_vong;
DELETE FROM dang_ky_hoc_phan;
DELETE FROM lich_thi;
DELETE FROM lich_hoc;
DELETE FROM lop_hoc_phan;
DELETE FROM chuong_trinh_dao_tao;
DELETE FROM mon_tien_quyet;
DELETE FROM hoc_ky;
DELETE FROM mon_hoc;
DELETE FROM sinh_vien;
DELETE FROM giang_vien;
DELETE FROM admin;
DELETE FROM khoi_kien_thuc;
DELETE FROM nganh;
...
('KT1.3', 'Khoi kien thuc giao duc dai cuong',    (SELECT id FROM nganh WHERE ma_nganh='HTTT')),
('KT2.3', 'Khoi kien thuc co so nganh',           (SELECT id FROM nganh WHERE ma_nganh='HTTT')),
('KT3.3', 'Khoi kien thuc chuyen nganh',          (SELECT id FROM nganh WHERE ma_nganh='HTTT')),
('KT4.3', 'Khoi tot nghiep',                      (SELECT id FROM nganh WHERE ma_nganh='HTTT'));
...
-- =============================================================
-- 9. CHUONG TRINH DAO TAO — CNTT (HK1-HK8)
-- =============================================================
...
-- =============================================================
-- 10. CHUONG TRINH DAO TAO — KTPM (HK1-HK4 co ban)
-- =============================================================
INSERT INTO chuong_trinh_dao_tao (nganh_id,mon_hoc_id,hoc_ky_thu,bat_buoc,khoi_id,so_tiet_phi,hoc_ky_du_kien_label,lt_bt,so_tiet_th,btl_damh,tt_da_kltn) VALUES
((SELECT id FROM nganh WHERE ma_nganh='KTPM'),(SELECT id FROM mon_hoc WHERE ma_mon='PE1213'), 1,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='GDTC' AND nganh_id IS NULL),3,'2022_2023_1(1)',0,90,0,0),
((SELECT id FROM nganh WHERE ma_nganh='KTPM'),(SELECT id FROM mon_hoc WHERE ma_mon='MI1216'), 1,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT1.2' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='KTPM')),2,'2022_2023_1(1)',30,0,0,0),
((SELECT id FROM nganh WHERE ma_nganh='KTPM'),(SELECT id FROM mon_hoc WHERE ma_mon='FL1219'), 1,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT1.2' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='KTPM')),3,'2022_2023_1(1)',30,30,0,0),
((SELECT id FROM nganh WHERE ma_nganh='KTPM'),(SELECT id FROM mon_hoc WHERE ma_mon='MI1208'), 1,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT1.2' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='KTPM')),3,'2022_2023_1(1)',30,30,0,0),
((SELECT id FROM nganh WHERE ma_nganh='KTPM'),(SELECT id FROM mon_hoc WHERE ma_mon='IT1110'), 1,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT2.2' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='KTPM')),3,'2022_2023_1(1)',30,30,0,0),
((SELECT id FROM nganh WHERE ma_nganh='KTPM'),(SELECT id FROM mon_hoc WHERE ma_mon='FL1220'), 2,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT1.2' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='KTPM')),3,'2022_2023_2(2)',30,30,0,0),
((SELECT id FROM nganh WHERE ma_nganh='KTPM'),(SELECT id FROM mon_hoc WHERE ma_mon='SSH1201'),2,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT1.2' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='KTPM')),3,'2022_2023_2(2)',45,0,0,0),
((SELECT id FROM nganh WHERE ma_nganh='KTPM'),(SELECT id FROM mon_hoc WHERE ma_mon='IT2030'), 2,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT2.2' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='KTPM')),3,'2022_2023_2(2)',30,30,0,0),
((SELECT id FROM nganh WHERE ma_nganh='KTPM'),(SELECT id FROM mon_hoc WHERE ma_mon='IT2060'), 3,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT2.2' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='KTPM')),3,'2023_2024_1(1)',30,30,0,0),
((SELECT id FROM nganh WHERE ma_nganh='KTPM'),(SELECT id FROM mon_hoc WHERE ma_mon='IT3020'), 3,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT2.2' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='KTPM')),3,'2023_2024_1(1)',45,0,0,0),
((SELECT id FROM nganh WHERE ma_nganh='KTPM'),(SELECT id FROM mon_hoc WHERE ma_mon='IT4060'), 4,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT3.2' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='KTPM')),3,'2023_2024_2(2)',30,30,0,0),
((SELECT id FROM nganh WHERE ma_nganh='KTPM'),(SELECT id FROM mon_hoc WHERE ma_mon='IT5010'), 8,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT4.2' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='KTPM')),7,'2025_2026_2(2)',0,0,0,210);

-- =============================================================
-- 11. CHUONG TRINH DAO TAO — HTTT (HK1-HK4 co ban)
-- =============================================================
INSERT INTO chuong_trinh_dao_tao (nganh_id,mon_hoc_id,hoc_ky_thu,bat_buoc,khoi_id,so_tiet_phi,hoc_ky_du_kien_label,lt_bt,so_tiet_th,btl_damh,tt_da_kltn) VALUES
((SELECT id FROM nganh WHERE ma_nganh='HTTT'),(SELECT id FROM mon_hoc WHERE ma_mon='PE1213'), 1,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='GDTC' AND nganh_id IS NULL),3,'2022_2023_1(1)',0,90,0,0),
((SELECT id FROM nganh WHERE ma_nganh='HTTT'),(SELECT id FROM mon_hoc WHERE ma_mon='FL1219'), 1,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT1.3' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='HTTT')),3,'2022_2023_1(1)',30,30,0,0),
((SELECT id FROM nganh WHERE ma_nganh='HTTT'),(SELECT id FROM mon_hoc WHERE ma_mon='IT1110'), 1,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT2.3' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='HTTT')),3,'2022_2023_1(1)',30,30,0,0),
((SELECT id FROM nganh WHERE ma_nganh='HTTT'),(SELECT id FROM mon_hoc WHERE ma_mon='IT2060'), 2,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT2.3' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='HTTT')),3,'2022_2023_2(2)',30,30,0,0),
((SELECT id FROM nganh WHERE ma_nganh='HTTT'),(SELECT id FROM mon_hoc WHERE ma_mon='IT3010'), 3,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT3.3' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='HTTT')),3,'2023_2024_1(1)',45,0,0,0),
((SELECT id FROM nganh WHERE ma_nganh='HTTT'),(SELECT id FROM mon_hoc WHERE ma_mon='IT5010'), 8,1,(SELECT id FROM khoi_kien_thuc WHERE ma_khoi='KT4.3' AND nganh_id=(SELECT id FROM nganh WHERE ma_nganh='HTTT')),7,'2025_2026_2(2)',0,0,0,210);

-- =============================================================
-- 12. LOP HOC PHAN — HK HIEN TAI (2026-2027 ky 1 — dang mo)
-- =============================================================
...
-- LOP HOC PHAN — CAC HK DA QUA (de co lich su hoc tap)
INSERT INTO lop_hoc_phan (ma_lop_hp,mon_hoc_id,hoc_ky_id,giang_vien_id,si_so_toi_da,si_so_hien_tai,trang_thai,version) VALUES
-- HK1 (2022-2023 ky 1)
...
('Dang ky nguyen vong HK1 2026-2027','Dang ky mon hoc du kien HK1 2026-2027',
 (SELECT id FROM hoc_ky WHERE nam_hoc='2026-2027' AND hoc_ky_thu=1),'2026-09-01','2026-09-30','DANG_MO');
...
-- =============================================================
-- 17. DANG KY HOC PHAN — HK HIEN TAI (SV001, SV002)
-- =============================================================
...
-- =============================================================
-- 18. DANG KY HOC PHAN — LICH SU SV001 (HK1-HK6 co diem)
-- =============================================================
INSERT INTO dang_ky_hoc_phan (sinh_vien_id,lop_hoc_phan_id,trang_thai,diem_giua_ky,diem_cuoi_ky,diem_tong_ket) VALUES
-- HK1: kha gioi
...
-- HK2: co 2 mon truot (FL1220=4.4, MI1213=4.8)
...
-- HK6: dang hoc (co diem GK)
((SELECT id FROM sinh_vien WHERE mssv='SV001'),(SELECT id FROM lop_hoc_phan WHERE ma_lop_hp='IT4020-K6'), 'DA_DANG_KY',7.0, NULL,NULL),
((SELECT id FROM sinh_vien WHERE mssv='SV001'),(SELECT id FROM lop_hoc_phan WHERE ma_lop_hp='IT4060-K6'), 'DA_DANG_KY',8.0, NULL,NULL),
...
-- =============================================================
-- 19. DANG KY HOC PHAN — LICH SU SV002 (HK1-HK2 co diem, HK3 dang hoc)
-- =============================================================
INSERT INTO dang_ky_hoc_phan (sinh_vien_id,lop_hoc_phan_id,trang_thai,diem_giua_ky,diem_cuoi_ky,diem_tong_ket) VALUES
...
-- =============================================================
-- 20. DANG KY NGUYEN VONG (SV001, SV002 dang ky kế hoạch hien tai)
-- =============================================================
INSERT INTO dang_ky_nguyen_vong (sinh_vien_id, nguyen_vong_mon_hoc_id, trang_thai) VALUES
((SELECT id FROM sinh_vien WHERE mssv='SV001'),
 (SELECT nvm.id FROM nguyen_vong_mon_hoc nvm JOIN mon_hoc mh ON mh.id=nvm.mon_hoc_id WHERE mh.ma_mon='IT3030' LIMIT 1),
 'DA_DUYET'),
((SELECT id FROM sinh_vien WHERE mssv='SV001'),
 (SELECT nvm.id FROM nguyen_vong_mon_hoc nvm JOIN mon_hoc mh ON mh.id=nvm.mon_hoc_id WHERE mh.ma_mon='IT4030' LIMIT 1),
 'CHO_DUYET'),
((SELECT id FROM sinh_vien WHERE mssv='SV002'),
 (SELECT nvm.id FROM nguyen_vong_mon_hoc nvm JOIN mon_hoc mh ON mh.id=nvm.mon_hoc_id WHERE mh.ma_mon='IT3030' LIMIT 1),
 'CHO_DUYET'),
((SELECT id FROM sinh_vien WHERE mssv='SV002'),
 (SELECT nvm.id FROM nguyen_vong_mon_hoc nvm JOIN mon_hoc mh ON mh.id=nvm.mon_hoc_id WHERE mh.ma_mon='IT3050' LIMIT 1),
 'DA_DUYET');

-- =============================================================
-- 21. DANG KY DINH HUONG (SV001 chon Cong nghe phan mem, SV002 chon Ky thuat phan mem)
-- =============================================================
INSERT INTO dang_ky_dinh_huong (sinh_vien_id, dinh_huong_id, trang_thai) VALUES
((SELECT id FROM sinh_vien WHERE mssv='SV001'),
 (SELECT id FROM dinh_huong WHERE ten_dinh_huong='Cong nghe phan mem'),
 'DA_DANG_KY'),
((SELECT id FROM sinh_vien WHERE mssv='SV002'),
 (SELECT id FROM dinh_huong WHERE ten_dinh_huong='Cong nghe phan mem'),
 'DA_DANG_KY');
...
-- =============================================================
-- 22. DANG KY THI LAI (SV001: FL1220=4.4, MI1213=4.8 — ca 2 duoi 5)
-- =============================================================
INSERT INTO dang_ky_thi_lai (sinh_vien_id, dang_ky_hp_id, trang_thai, ghi_chu) VALUES
((SELECT id FROM sinh_vien WHERE mssv='SV001'),
 (SELECT dkhp.id FROM dang_ky_hoc_phan dkhp
  JOIN lop_hoc_phan lhp ON lhp.id=dkhp.lop_hoc_phan_id
  JOIN mon_hoc mh ON mh.id=lhp.mon_hoc_id
  WHERE dkhp.sinh_vien_id=(SELECT id FROM sinh_vien WHERE mssv='SV001')
    AND mh.ma_mon='FL1220' LIMIT 1),
 'CHO_DUYET', 'Dang ky thi lai Tieng Anh 2'),
((SELECT id FROM sinh_vien WHERE mssv='SV001'),
 (SELECT dkhp.id FROM dang_ky_hoc_phan dkhp
  JOIN lop_hoc_phan lhp ON lhp.id=dkhp.lop_hoc_phan_id
  JOIN mon_hoc mh ON mh.id=lhp.mon_hoc_id
  WHERE dkhp.sinh_vien_id=(SELECT id FROM sinh_vien WHERE mssv='SV001')
    AND mh.ma_mon='MI1213' LIMIT 1),
 'DA_DUYET', 'Dang ky thi lai Toan roi rac — da duyet');

-- =============================================================
-- 23. CAP NHAT HOC KY THUC TE trong CTDT (cho trang CT hoc)
-- =============================================================
UPDATE chuong_trinh_dao_tao SET hoc_ky_thuc_te_label='2022_2023_1(1)'
WHERE nganh_id=(SELECT id FROM nganh WHERE ma_nganh='CNTT')
  AND mon_hoc_id IN (SELECT id FROM mon_hoc WHERE ma_mon IN ('PE1213','MI1216','MI1209','SSH1207','FL1219','MI1208','IT1110'));

UPDATE chuong_trinh_dao_tao SET hoc_ky_thuc_te_label='2022_2023_2(2)'
WHERE nganh_id=(SELECT id FROM nganh WHERE ma_nganh='CNTT')
  AND mon_hoc_id IN (SELECT id FROM mon_hoc WHERE ma_mon IN ('FL1220','SSH1201','SSH1206','MI1212','MI1213','IT1120','IT2070'));

UPDATE chuong_trinh_dao_tao SET hoc_ky_thuc_te_label='2023_2024_1(1)'
WHERE nganh_id=(SELECT id FROM nganh WHERE ma_nganh='CNTT')
  AND mon_hoc_id IN (SELECT id FROM mon_hoc WHERE ma_mon IN ('SSH1204','SSH1205','IT2020','IT2030','IT2040','IT2060'));

UPDATE chuong_trinh_dao_tao SET hoc_ky_thuc_te_label='2023_2024_2(2)'
WHERE nganh_id=(SELECT id FROM nganh WHERE ma_nganh='CNTT')
  AND mon_hoc_id IN (SELECT id FROM mon_hoc WHERE ma_mon IN ('IT2050','IT3010','IT3020','IT3030','IT3040','QP1101'));

UPDATE chuong_trinh_dao_tao SET hoc_ky_thuc_te_label='2024_2025_1(1)'
WHERE nganh_id=(SELECT id FROM nganh WHERE ma_nganh='CNTT')
  AND mon_hoc_id IN (SELECT id FROM mon_hoc WHERE ma_mon IN ('IT3050','IT3060','IT4010','IT4030','IT4050'));
